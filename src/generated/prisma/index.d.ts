...
export namespace Prisma {
  ...
  */
    ...
    model: {
      ...
      TestCasesResult: {
        ...
        operations: {
          ...
          findRaw: {
            args: Prisma.TestCasesResultFindRawArgs<ExtArgs>
            result: JsonObject
          }
          aggregateRaw: {
            args: Prisma.TestCasesResultAggregateRawArgs<ExtArgs>
            result: JsonObject
          }
          count: {
      ...
      ProblemSolved: {
        ...
        operations: {
          ...
          findRaw: {
            args: Prisma.ProblemSolvedFindRawArgs<ExtArgs>
            result: JsonObject
          }
          aggregateRaw: {
            args: Prisma.ProblemSolvedAggregateRawArgs<ExtArgs>
            result: JsonObject
          }
          count: {
  ...
  export type UserOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "username" | "fullname" | "email" | "image" | "password" | "refreshToken" | "role" | "createdAt" | "updatedAt", ExtArgs["result"]["user"]>
  ...
  export type ProblemOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "title" | "description" | "difficulty" | "tags" | "userId" | "example" | "company" | "demo" | "templateCode" | "constraints" | "hints" | "editorial" | "codeSnippets" | "testCases" | "referenceSolution" | "createdAt" | "updatedAt", ExtArgs["result"]["problem"]>
  ...
  interface ProblemFieldRefs {
    ...
    readonly demo: FieldRef<"Problem", 'Boolean'>
    readonly templateCode: FieldRef<"Problem", 'Json'>
  ...
  export type SubmissionOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "userId" | "problemId" | "sourceCode" | "language" | "stdin" | "stderr" | "stdout" | "compileOutput" | "status" | "memory" | "time" | "createdAt" | "updatedAt", ExtArgs["result"]["submission"]>
  ...
  export type TestCasesResultOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "submissionId" | "testCases" | "passed" | "stdout" | "expected" | "stderr" | "compileOutput" | "status" | "memory" | "time" | "createdAt" | "updatedAt", ExtArgs["result"]["testCasesResult"]>
  ...
  export interface TestCasesResultDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    ...
    /**
     * Find zero or more TestCasesResults that matches the filter.
     * @param {TestCasesResultFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const testCasesResult = await prisma.testCasesResult.findRaw({
     *   filter: { age: { $gt: 25 } }
     * })
     */
    findRaw(args?: TestCasesResultFindRawArgs): Prisma.PrismaPromise<JsonObject>

    /**
     * Perform aggregation operations on a TestCasesResult.
     * @param {TestCasesResultAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const testCasesResult = await prisma.testCasesResult.aggregateRaw({
     *   pipeline: [
     *     { $match: { status: "registered" } },
     *     { $group: { _id: "$country", total: { $sum: 1 } } }
     *   ]
     * })
     */
    aggregateRaw(args?: TestCasesResultAggregateRawArgs): Prisma.PrismaPromise<JsonObject>
  ...
  /**
   * TestCasesResult findRaw
   */
  export type TestCasesResultFindRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * The query predicate filter. If unspecified, then all documents in the collection will match the predicate. ${@link https://docs.mongodb.com/manual/reference/operator/query MongoDB Docs}.
     */
    filter?: InputJsonValue
  ...
  /**
   * TestCasesResult aggregateRaw
   */
  export type TestCasesResultAggregateRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * An array of aggregation stages to process and transform the document stream via the aggregation pipeline. ${@link https://docs.mongodb.com/manual/reference/operator/aggregation-pipeline MongoDB Docs}.
     */
    pipeline?: InputJsonValue[]
  ...
  export interface ProblemSolvedDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    ...
    /**
     * Find zero or more ProblemSolveds that matches the filter.
     * @param {ProblemSolvedFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const problemSolved = await prisma.problemSolved.findRaw({
     *   filter: { age: { $gt: 25 } }
     * })
     */
    findRaw(args?: ProblemSolvedFindRawArgs): Prisma.PrismaPromise<JsonObject>

    /**
     * Perform aggregation operations on a ProblemSolved.
     * @param {ProblemSolvedAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const problemSolved = await prisma.problemSolved.aggregateRaw({
     *   pipeline: [
     *     { $match: { status: "registered" } },
     *     { $group: { _id: "$country", total: { $sum: 1 } } }
     *   ]
     * })
     */
    aggregateRaw(args?: ProblemSolvedAggregateRawArgs): Prisma.PrismaPromise<JsonObject>
  ...
  /**
   * ProblemSolved findRaw
   */
  export type ProblemSolvedFindRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * The query predicate filter. If unspecified, then all documents in the collection will match the predicate. ${@link https://docs.mongodb.com/manual/reference/operator/query MongoDB Docs}.
     */
    filter?: InputJsonValue
  ...
  /**
   * ProblemSolved aggregateRaw
   */
  export type ProblemSolvedAggregateRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * An array of aggregation stages to process and transform the document stream via the aggregation pipeline. ${@link https://docs.mongodb.com/manual/reference/operator/aggregation-pipeline MongoDB Docs}.
     */
    pipeline?: InputJsonValue[]
  ...
  export type ProblemWhereInput = {
    ...
    demo?: BoolFilter<"Problem"> | boolean
    templateCode?: JsonFilter<"Problem">
  ...
  export type ProblemScalarWhereWithAggregatesInput = {
    ...
    company?: StringNullableListFilter<"Problem">
    demo?: BoolWithAggregatesFilter<"Problem"> | boolean
    templateCode?: JsonWithAggregatesFilter<"Problem">
    constraints?: StringNullableListFilter<"Problem">
    hints?: StringNullableListFilter<"Problem">
  ...
  export type ProblemUpdateInput = {
    ...
    example?: InputJsonValue | InputJsonValue
    company?: ProblemUpdatecompanyInput | string[]
    demo?: BoolFieldUpdateOperationsInput | boolean
    templateCode?: InputJsonValue | InputJsonValue
    ...
    codeSnippets?: InputJsonValue | InputJsonValue
    testCases?: InputJsonValue | InputJsonValue
    referenceSolution?: InputJsonValue | InputJsonValue
    createdAt?: DateTimeFieldUpdateOperationsInput | Date | string
    updatedAt?: DateTimeFieldUpdateOperationsInput | Date | string
  ...
  export type SubmissionUpdateInput = {
    sourceCode?: InputJsonValue | InputJsonValue
